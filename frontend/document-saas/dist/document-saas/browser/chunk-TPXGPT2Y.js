...
var SignalRService = class _SignalRService {
  ...
  constructor() {
    window.addEventListener("auth:login", this.onLogin.bind(this));
    window.addEventListener("auth:logout", this.onLogout.bind(this));
  }
  ngOnDestroy() {
    window.removeEventListener("auth:login", this.onLogin.bind(this));
    window.removeEventListener("auth:logout", this.onLogout.bind(this));
    this.stopConnection();
  }
  onLogin() {
  ...
  startConnection() {
    ...
    this.hubConnection = new HubConnectionBuilder().withUrl(`${environment.notificationUrl}/hubs/notifications`, {
...
//# sourceMappingURL=chunk-TPXGPT2Y.js.map
